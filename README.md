...
|---------|-------------|--------|---------|
| JournalApp | Full-stack journaling app with mood analytics, streak heatmaps, and speech-to-text. | [GitHub](https://github.com/Akarshan-real/JournalApp) | [Website](https://journal-app-theta-nine.vercel.app/) |
| MegaBlog | Blog platform built with React 19, TypeScript, Vite, Appwrite BaaS, Redux, and TinyMCE. | [GitHub](https://github.com/Akarshan-real/MegaBlog) | [Website](https://mega-blog-beryl-three.vercel.app) |
| TODO | Cloud-synced task manager with React 19, Express, MongoDB Atlas, batch ops, and rollback. | [GitHub](https://github.com/Akarshan-real/TODO) | [Website](https://todo-eight-theta-42.vercel.app) |
| Reze Bot | Anime-themed Discord bot for collecting, evolving, trading, and battling cards. | — | [Website](https://rezebot.xyz/) |
